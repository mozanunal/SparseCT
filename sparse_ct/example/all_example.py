...
if __name__ == "__main__":
    ...
    gt, sinogram, theta, FOCUS = image_to_sparse_sinogram(fname, channel=1,
            n_proj=64, size=512, angle1=0.0, angle2=180.0, noise_pow=45.0 )
    ...
    recon_sart = SartReconstructor('SART', sart_n_iter=4, sart_relaxation=0.15)
    ...
    recon_dip_rand = DgrReconstructor('RDGRV2', 
                                dip_n_iter=4001, 
                                net='skip',
                                lr=0.01,
                                reg_std=1./100,
    ...
    recon_dip.set_for_metric(gt, img_sart_tv, FOCUS=FOCUS, log_dir='../log/dip')
    img_dip = recon_dip.calc(sinogram, theta)

    recon_dip_rand.set_for_metric(gt, img_sart_tv, FOCUS=FOCUS, log_dir='../log/dip')
    ...
    plot_grid([
            ...
            img_dip, img_dip_rand, img_n2self_selfsuper,
