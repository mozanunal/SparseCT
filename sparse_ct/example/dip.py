...
if __name__ == "__main__":
    ...
    recon_dip1 = DipReconstructor('DIP_1.0_0.0_0.0_0.0', theta, 
                                dip_n_iter=8000, 
                                net='skip',
                                lr=0.001,
                                reg_std=1./100,
    ...
    recon_dip2 = DipReconstructor('DIP_0.0_1.0_0.0_0.0', theta, 
                                dip_n_iter=8000, 
                                net='skip',
                                lr=0.001,
                                reg_std=1./100,
    ...
    recon_dip3 = DipReconstructor('DIP_0.5_0.5_0.0_0.0', theta, 
                                dip_n_iter=8000, 
                                net='skip',
                                lr=0.001,
                                reg_std=1./100,
    ...
    recon_dip4 = DipReconstructor('DIP_0.99_0.01_0.0_0.0', theta, 
                                dip_n_iter=8000, 
                                net='skip',
                                lr=0.001,
                                reg_std=1./100,
    ...
    recon_dip5 = DipReconstructor('DIP_0.5_0.0_0.5_0.0', theta, 
                                dip_n_iter=8000, 
                                net='skip',
                                lr=0.001,
                                reg_std=1./100,
    ...
    recon_dip6 = DipReconstructor('DIP_0.9_0.0_0.1_0.0', theta, 
                                dip_n_iter=8000, 
                                net='skip',
                                lr=0.001,
                                reg_std=1./100,
    ...
    recon_dip7 = DipReconstructor('DIP_0.99_0.0_0.01_0.0', theta, 
                                dip_n_iter=8000, 
                                net='skip',
                                lr=0.001,
                                reg_std=1./100,
    ...
    plot_grid([gt, img_fbp, img_sart, img_dip1, 
            ...
            FOCUS=FOCUS, save_name='ct2.png', dpi=1000)
